...
public class RecordsController {
    ...
    @RequestMapping(value = {"/artist/{id}/records.json"}, method = RequestMethod.GET)
    ...
    @RequestMapping(value = {"/artist/{id}/record.json"}, method = RequestMethod.POST)
    ...
    @RequestMapping(value = {"/records/search.json"}, method = RequestMethod.GET)
